<div align="center">
  <h1>Hi 👋, I'm Sandeep Tiwari</h1>
  <h3>Senior Backend Developer | Node.js • Nest.js • Distributed Systems • AWS</h3>
...
- 💼 **Senior Backend Developer** with 4+ years of experience building high-throughput REST APIs, event-driven microservices, and multi-tenant architectures.
- 🛠️ **Core Focus:** Low-latency backend systems, asynchronous job queues (**Redis / BullMQ**), and cloud serverless ecosystems (**AWS**).
- ⚙️ **Currently Scaling:** Distributed microservices, real-time WebSocket infrastructures, and third-party payment/e-commerce integrations (Stripe Connect, Alibaba 1688 API).
- 💬 **Ask Me About:** Nest.js, Node.js, TypeScript, PostgreSQL indexing, Redis caching patterns, RBAC authentication, and Docker containerization.
